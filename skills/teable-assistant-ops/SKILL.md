...
| Authority | Advanced permissions, roles, grants, and matrix state | `authority get/export/diff/apply/enable/disable/role-*` | [authority-guide.md](guides/authority-guide.md) |
